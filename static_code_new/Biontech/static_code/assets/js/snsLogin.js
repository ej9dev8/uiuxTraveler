 ...
 */
	this.init_naver_id_login = function ()
	{
		...
		{
			naver_id_login_contents="<a href='"+naver_id_login_url+"' "+naver_id_popup_option+" id='naver_id_login_anchor'><img src='/assets/img/member/sns_login_btn_img02.png' src='네이버 로그인'></a> ";
		}
